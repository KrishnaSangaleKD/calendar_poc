import 'package:calendar_poc/utils/colors_util.dart';
...
class _MyHomePageState extends State<MyHomePage> {
  ...
  void initState() {
    ...
    selectedEvents = ValueNotifier(getEventsForDay(currentDateTime));
    tableCalendar = TableCalendar(
      ...
      onDaySelected: (selectedDay, focusedDay) {
        setState(() {
          ...
          currentMonthList = date_util.DateUtils.daysInMonth(selectedDay);
          currentMonthList.sort((a, b) => a.day.compareTo(b.day));
          currentMonthList = currentMonthList.toSet().toList();
          ...
          child: Center(
            child: Column(
              ...
              children: <Widget>[
                ...
                if (events.entries
                    .where((element) => date_util.DateUtils.isSameDay(
                        element.key, currentMonthList[index]))
                    .isNotEmpty)
                  Container(
                    width: 5,
                    height: 5,
                        ...
                        child: ElevatedButton(
                          onPressed: () {
                            setState(() {
                              events.addAll({
                                currentDateTime: [
                                  Event(controller.text, currentDateTime)
                                ]
                              });
                            });
